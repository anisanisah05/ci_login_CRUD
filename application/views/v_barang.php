...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:150px; margin-left:130px; margin-top:-100px;" >
                    <div class="card">
                        <div class="header">
                            <div class="row clearfix" style="margin-left:400px; ">
                        ...
                        <div class="body">
                        <div class="row">
                        <a style="margin: 35px;margin-left: 1px; background-color:black;border-color:black;" href="#tambah"
class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphiconplus"></span>
Tambah</a>
...
BARANG</th><th>HARGA</th><th>STOK</th><th>ID
KATEGORI</th>
